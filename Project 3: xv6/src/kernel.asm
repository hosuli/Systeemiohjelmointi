...
80102302:	81 fb c8 55 11 80    	cmp    $0x801155c8,%ebx
...
80102e06:	80 
80102e07:	c7 04 24 c8 55 11 80 	movl   $0x801155c8,(%esp)
...
80102e3a:	e8 b1 29 00 00       	call   801057f0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
...
801034c4:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
// If found, change state to EMBRYO and initialize
// state required to run in the kernel.
// Otherwise return 0.
static struct proc*
...
801034c9:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&ptable.lock);
801034cc:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
801034e3:	81 fb 74 4d 11 80    	cmp    $0x80114d74,%ebx
...
801034f2:	a1 04 a0 10 80       	mov    0x8010a004,%eax
  ...
  release(&ptable.lock);
801034f7:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 18 54 10 80 	movl   $0x80105418,0x14(%eax)
...
80103564:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&ptable.lock);
80103568:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103593:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80103596:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
801035ed:	80 
801035ee:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
8010360f:	e8 4c f1 ff ff       	call   80102760 <lapicid>
  ...
  for (i = 0; i < ncpu; ++i) {
80103614:	8b 35 20 2d 11 80    	mov    0x80112d20,%esi
8010361a:	85 f6                	test   %esi,%esi
8010361c:	7e 3c                	jle    8010365a <mycpu+0x5a>
    if (cpus[i].apicid == apicid)
8010361e:	0f b6 15 a0 27 11 80 	movzbl 0x801127a0,%edx
80103625:	39 c2                	cmp    %eax,%edx
80103627:	74 2d                	je     80103656 <mycpu+0x56>
80103629:	b9 50 28 11 80       	mov    $0x80112850,%ecx
    panic("mycpu called with interrupts enabled\n");
...
8010364f:	5d                   	pop    %ebp
  ...
  for (i = 0; i < ncpu; ++i) {
    if (cpus[i].apicid == apicid)
      return &cpus[i];
80103650:	05 a0 27 11 80       	add    $0x801127a0,%eax
  }
  panic("unknown apicid\n");
}
80103655:	c3                   	ret    
...
cpuid() {
  return mycpu()-cpus;
8010368c:	2d a0 27 11 80       	sub    $0x801127a0,%eax
...
801037ae:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  ...
  release(&ptable.lock);
801037b5:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103902:	8b 5f 10             	mov    0x10(%edi),%ebx
  ...
  acquire(&ptable.lock);
80103905:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103911:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  ...
  release(&ptable.lock);
80103918:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103980:	fb                   	sti    
  for(;;){
    ...
    acquire(&ptable.lock);
80103981:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103988:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
  for(;;){
    // Enable interrupts on this processor.
    sti();
...
8010399b:	81 fb 74 4d 11 80    	cmp    $0x80114d74,%ebx
...
801039d0:	e8 bb 2b 00 00       	call   80106590 <switchkvm>
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039d5:	81 fb 74 4d 11 80    	cmp    $0x80114d74,%ebx
      swtch(&(c->scheduler), p->context);
      switchkvm();
...
801039e7:	90                   	nop
    ...
    release(&ptable.lock);
801039e8:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103a0d:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
// there's no process.
void
sched(void)
{
...
80103af5:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  ...
  acquire(&ptable.lock);
80103afc:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103b38:	81 fa 74 4d 11 80    	cmp    $0x80114d74,%edx
...
80103b45:	b9 74 2d 11 80       	mov    $0x80112d74,%ecx
...
80103b53:	81 f9 74 4d 11 80    	cmp    $0x80114d74,%ecx
...
80103b69:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
...
80103b73:	81 fa 74 4d 11 80    	cmp    $0x80114d74,%edx
...
80103bde:	e8 1d fe ff ff       	call   80103a00 <sched>
  release(&ptable.lock);
80103be3:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103c22:	81 fe 40 2d 11 80    	cmp    $0x80112d40,%esi
80103c28:	74 46                	je     80103c70 <sleep+0x70>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103c2a:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103c4d:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103c54:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103cf1:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cf6:	81 fb 74 4d 11 80    	cmp    $0x80114d74,%ebx
...
80103d0b:	c7 44 24 04 40 2d 11 	movl   $0x80112d40,0x4(%esp)
80103d12:	80 
...
80103d38:	e8 d3 2b 00 00       	call   80106910 <freevm>
        ...
        p->state = UNUSED;
        release(&ptable.lock);
80103d3d:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
...
80103dcf:	3d 74 4d 11 80       	cmp    $0x80114d74,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103dd8:	c7 45 08 40 2d 11 80 	movl   $0x80112d40,0x8(%ebp)
}
...
80103e76:	bb e0 2d 11 80       	mov    $0x80112de0,%ebx
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 bb 75 10 80 	movl   $0x801075bb,(%esp)
...
80103e94:	83 eb 80             	sub    $0xffffff80,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e97:	81 fb e0 4d 11 80    	cmp    $0x80114de0,%ebx
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
80104237:	c7 04 24 e1 72 10 80 	movl   $0x801072e1,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104289:	c7 04 24 e9 72 10 80 	movl   $0x801072e9,(%esp)
...
80104670:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
80104672:	8b 56 1c             	mov    0x1c(%esi),%edx

//increase the counter by 1
  if (num == callnumber) {
80104675:	3b 15 08 a0 10 80    	cmp    0x8010a008,%edx
8010467b:	74 6b                	je     801046e8 <syscall+0x88>
    counter++;
  }
//when the system call being called is getreadcount, update the counter value for it 
  if (num == SYS_getreadcount) {
8010467d:	83 fa 16             	cmp    $0x16,%edx
80104680:	74 56                	je     801046d8 <syscall+0x78>
    curproc->counter = counter;

  }

  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104682:	8d 42 ff             	lea    -0x1(%edx),%eax
80104685:	83 f8 15             	cmp    $0x15,%eax
80104688:	77 1e                	ja     801046a8 <syscall+0x48>
8010468a:	8b 04 95 20 73 10 80 	mov    -0x7fef8ce0(,%edx,4),%eax
80104691:	85 c0                	test   %eax,%eax
80104693:	74 13                	je     801046a8 <syscall+0x48>
    curproc->tf->eax = syscalls[num]();
80104695:	ff d0                	call   *%eax
...
801046a8:	8d 43 6c             	lea    0x6c(%ebx),%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
801046ab:	89 54 24 0c          	mov    %edx,0xc(%esp)
            curproc->pid, curproc->name, num);
...
801046b6:	c7 04 24 f1 72 10 80 	movl   $0x801072f1,(%esp)
...
//when the system call being called is getreadcount, update the counter value for it 
  if (num == SYS_getreadcount) {
    curproc->counter = counter;
801046d8:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
801046dd:	89 43 7c             	mov    %eax,0x7c(%ebx)
801046e0:	eb a0                	jmp    80104682 <syscall+0x22>
...
//increase the counter by 1
  if (num == callnumber) {
    counter++;
801046e8:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
801046ef:	eb 8c                	jmp    8010467d <syscall+0x1d>
801046f1:	66 90                	xchg   %ax,%ax
...
80104706:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104709:	e8 92 ef ff ff       	call   801036a0 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
8010470e:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
80104710:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80104714:	85 c9                	test   %ecx,%ecx
80104716:	74 18                	je     80104730 <fdalloc+0x30>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
8010471b:	83 fa 10             	cmp    $0x10,%edx
8010471e:	75 f0                	jne    80104710 <fdalloc+0x10>
      curproc->ofile[fd] = f;
      return fd;
    }
  }
...
8010472c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
80104730:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
      return fd;
    }
  }
  return -1;
}
80104734:	83 c4 04             	add    $0x4,%esp
  struct proc *curproc = myproc();
...
80104746:	83 ec 3c             	sub    $0x3c,%esp
80104749:	89 4d d0             	mov    %ecx,-0x30(%ebp)
8010474c:	8b 4d 08             	mov    0x8(%ebp),%ecx
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010474f:	8d 5d da             	lea    -0x26(%ebp),%ebx
80104752:	89 5c 24 04          	mov    %ebx,0x4(%esp)
...
create(char *path, short type, short major, short minor)
{
80104759:	89 55 d4             	mov    %edx,-0x2c(%ebp)
8010475c:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010475f:	e8 bc d7 ff ff       	call   80101f20 <nameiparent>
80104764:	85 c0                	test   %eax,%eax
80104766:	89 c7                	mov    %eax,%edi
80104768:	0f 84 da 00 00 00    	je     80104848 <create+0x108>
    return 0;
  ilock(dp);
8010476e:	89 04 24             	mov    %eax,(%esp)
80104771:	e8 3a cf ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104776:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010477d:	00 
8010477e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104782:	89 3c 24             	mov    %edi,(%esp)
80104785:	e8 36 d4 ff ff       	call   80101bc0 <dirlookup>
8010478a:	85 c0                	test   %eax,%eax
8010478c:	89 c6                	mov    %eax,%esi
8010478e:	74 40                	je     801047d0 <create+0x90>
    iunlockput(dp);
80104790:	89 3c 24             	mov    %edi,(%esp)
80104793:	e8 78 d1 ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104798:	89 34 24             	mov    %esi,(%esp)
8010479b:	e8 10 cf ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801047a0:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801047a5:	75 11                	jne    801047b8 <create+0x78>
801047a7:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
801047ac:	89 f0                	mov    %esi,%eax
801047ae:	75 08                	jne    801047b8 <create+0x78>
...
801047bb:	e8 50 d1 ff ff       	call   80101910 <iunlockput>
    panic("create: dirlink");
...
801047d0:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
801047d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801047d8:	8b 07                	mov    (%edi),%eax
801047da:	89 04 24             	mov    %eax,(%esp)
801047dd:	e8 3e cd ff ff       	call   80101520 <ialloc>
801047e2:	85 c0                	test   %eax,%eax
801047e4:	89 c6                	mov    %eax,%esi
801047e6:	0f 84 bf 00 00 00    	je     801048ab <create+0x16b>
    panic("create: ialloc");

  ilock(ip);
801047ec:	89 04 24             	mov    %eax,(%esp)
801047ef:	e8 bc ce ff ff       	call   801016b0 <ilock>
  ip->major = major;
801047f4:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
801047f8:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
801047fc:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104800:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104804:	b8 01 00 00 00       	mov    $0x1,%eax
80104809:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
8010480d:	89 34 24             	mov    %esi,(%esp)
80104810:	e8 db cd ff ff       	call   801015f0 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80104815:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010481a:	74 34                	je     80104850 <create+0x110>
...
8010481c:	8b 46 04             	mov    0x4(%esi),%eax
8010481f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104823:	89 3c 24             	mov    %edi,(%esp)
80104826:	89 44 24 08          	mov    %eax,0x8(%esp)
8010482a:	e8 f1 d5 ff ff       	call   80101e20 <dirlink>
8010482f:	85 c0                	test   %eax,%eax
80104831:	78 6c                	js     8010489f <create+0x15f>
    panic("create: dirlink");

  iunlockput(dp);
80104833:	89 3c 24             	mov    %edi,(%esp)
80104836:	e8 d5 d0 ff ff       	call   80101910 <iunlockput>

  return ip;
}
8010483b:	83 c4 3c             	add    $0x3c,%esp
  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
...
8010484a:	e9 61 ff ff ff       	jmp    801047b0 <create+0x70>
8010484f:	90                   	nop
  ip->minor = minor;
  ip->nlink = 1;
  iupdate(ip);
  ...
  if(type == T_DIR){  // Create . and .. entries.
    dp->nlink++;  // for ".."
80104850:	66 83 47 56 01       	addw   $0x1,0x56(%edi)
    iupdate(dp);
80104855:	89 3c 24             	mov    %edi,(%esp)
80104858:	e8 93 cd ff ff       	call   801015f0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010485d:	8b 46 04             	mov    0x4(%esi),%eax
80104860:	c7 44 24 04 98 73 10 	movl   $0x80107398,0x4(%esp)
80104867:	80 
80104868:	89 34 24             	mov    %esi,(%esp)
8010486b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010486f:	e8 ac d5 ff ff       	call   80101e20 <dirlink>
80104874:	85 c0                	test   %eax,%eax
80104876:	78 1b                	js     80104893 <create+0x153>
80104878:	8b 47 04             	mov    0x4(%edi),%eax
8010487b:	c7 44 24 04 97 73 10 	movl   $0x80107397,0x4(%esp)
80104882:	80 
80104883:	89 34 24             	mov    %esi,(%esp)
80104886:	89 44 24 08          	mov    %eax,0x8(%esp)
8010488a:	e8 91 d5 ff ff       	call   80101e20 <dirlink>
8010488f:	85 c0                	test   %eax,%eax
80104891:	79 89                	jns    8010481c <create+0xdc>
      panic("create dots");
80104893:	c7 04 24 8b 73 10 80 	movl   $0x8010738b,(%esp)
8010489a:	e8 c1 ba ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010489f:	c7 04 24 9a 73 10 80 	movl   $0x8010739a,(%esp)
801048a6:	e8 b5 ba ff ff       	call   80100360 <panic>
    iunlockput(ip);
    return 0;
  }
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
801048ab:	c7 04 24 7c 73 10 80 	movl   $0x8010737c,(%esp)
801048b2:	e8 a9 ba ff ff       	call   80100360 <panic>
801048b7:	89 f6                	mov    %esi,%esi
801048b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

801048c0 <argfd.constprop.0>:
#include "fcntl.h"
...
801048c7:	89 d3                	mov    %edx,%ebx
801048c9:	83 ec 20             	sub    $0x20,%esp
{
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
801048cc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801048cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801048d3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801048da:	e8 b1 fc ff ff       	call   80104590 <argint>
801048df:	85 c0                	test   %eax,%eax
801048e1:	78 2d                	js     80104910 <argfd.constprop.0+0x50>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801048e3:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
801048e7:	77 27                	ja     80104910 <argfd.constprop.0+0x50>
801048e9:	e8 b2 ed ff ff       	call   801036a0 <myproc>
801048ee:	8b 55 f4             	mov    -0xc(%ebp),%edx
801048f1:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
801048f5:	85 c0                	test   %eax,%eax
801048f7:	74 17                	je     80104910 <argfd.constprop.0+0x50>
    return -1;
  if(pfd)
801048f9:	85 f6                	test   %esi,%esi
801048fb:	74 02                	je     801048ff <argfd.constprop.0+0x3f>
    *pfd = fd;
801048fd:	89 16                	mov    %edx,(%esi)
  if(pf)
801048ff:	85 db                	test   %ebx,%ebx
80104901:	74 1d                	je     80104920 <argfd.constprop.0+0x60>
    *pf = f;
80104903:	89 03                	mov    %eax,(%ebx)
  return 0;
80104905:	31 c0                	xor    %eax,%eax
}
80104907:	83 c4 20             	add    $0x20,%esp
8010490a:	5b                   	pop    %ebx
8010490b:	5e                   	pop    %esi
8010490c:	5d                   	pop    %ebp
8010490d:	c3                   	ret    
...
80104922:	eb e3                	jmp    80104907 <argfd.constprop.0+0x47>
...
80104936:	83 ec 24             	sub    $0x24,%esp
  struct file *f;
  int fd;

  if(argfd(0, 0, &f) < 0)
80104939:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010493c:	e8 7f ff ff ff       	call   801048c0 <argfd.constprop.0>
80104941:	85 c0                	test   %eax,%eax
80104943:	78 23                	js     80104968 <sys_dup+0x38>
    return -1;
  if((fd=fdalloc(f)) < 0)
80104945:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104948:	e8 b3 fd ff ff       	call   80104700 <fdalloc>
8010494d:	85 c0                	test   %eax,%eax
8010494f:	89 c3                	mov    %eax,%ebx
80104951:	78 15                	js     80104968 <sys_dup+0x38>
    return -1;
  filedup(f);
80104953:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104956:	89 04 24             	mov    %eax,(%esp)
80104959:	e8 82 c4 ff ff       	call   80100de0 <filedup>
  return fd;
8010495e:	89 d8                	mov    %ebx,%eax
}
80104960:	83 c4 24             	add    $0x24,%esp
80104963:	5b                   	pop    %ebx
80104964:	5d                   	pop    %ebp
80104965:	c3                   	ret    
...
8010496d:	eb f1                	jmp    80104960 <sys_dup+0x30>
8010496f:	90                   	nop
...
8010497b:	e8 40 ff ff ff       	call   801048c0 <argfd.constprop.0>
80104980:	85 c0                	test   %eax,%eax
80104982:	78 54                	js     801049d8 <sys_read+0x68>
80104984:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104987:	89 44 24 04          	mov    %eax,0x4(%esp)
8010498b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104992:	e8 f9 fb ff ff       	call   80104590 <argint>
80104997:	85 c0                	test   %eax,%eax
80104999:	78 3d                	js     801049d8 <sys_read+0x68>
...
801049b0:	e8 0b fc ff ff       	call   801045c0 <argptr>
801049b5:	85 c0                	test   %eax,%eax
801049b7:	78 1f                	js     801049d8 <sys_read+0x68>
    return -1;
...
801049cd:	e8 6e c5 ff ff       	call   80100f40 <fileread>
}
801049d2:	c9                   	leave  
801049d3:	c3                   	ret    
...
801049eb:	e8 d0 fe ff ff       	call   801048c0 <argfd.constprop.0>
801049f0:	85 c0                	test   %eax,%eax
801049f2:	78 54                	js     80104a48 <sys_write+0x68>
801049f4:	8d 45 f0             	lea    -0x10(%ebp),%eax
801049f7:	89 44 24 04          	mov    %eax,0x4(%esp)
801049fb:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104a02:	e8 89 fb ff ff       	call   80104590 <argint>
80104a07:	85 c0                	test   %eax,%eax
80104a09:	78 3d                	js     80104a48 <sys_write+0x68>
...
80104a20:	e8 9b fb ff ff       	call   801045c0 <argptr>
80104a25:	85 c0                	test   %eax,%eax
80104a27:	78 1f                	js     80104a48 <sys_write+0x68>
    return -1;
...
80104a3d:	e8 9e c5 ff ff       	call   80100fe0 <filewrite>
}
80104a42:	c9                   	leave  
80104a43:	c3                   	ret    
...
80104a53:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argfd(0, &fd, &f) < 0)
80104a56:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104a59:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104a5c:	e8 5f fe ff ff       	call   801048c0 <argfd.constprop.0>
80104a61:	85 c0                	test   %eax,%eax
80104a63:	78 23                	js     80104a88 <sys_close+0x38>
    return -1;
  myproc()->ofile[fd] = 0;
80104a65:	e8 36 ec ff ff       	call   801036a0 <myproc>
80104a6a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104a6d:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104a74:	00 
  fileclose(f);
80104a75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a78:	89 04 24             	mov    %eax,(%esp)
80104a7b:	e8 b0 c3 ff ff       	call   80100e30 <fileclose>
  return 0;
...
80104a95:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80104a98:	8d 55 f0             	lea    -0x10(%ebp),%edx
80104a9b:	e8 20 fe ff ff       	call   801048c0 <argfd.constprop.0>
80104aa0:	85 c0                	test   %eax,%eax
80104aa2:	78 34                	js     80104ad8 <sys_fstat+0x48>
80104aa4:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104aa7:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104aae:	00 
80104aaf:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ab3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104aba:	e8 01 fb ff ff       	call   801045c0 <argptr>
80104abf:	85 c0                	test   %eax,%eax
80104ac1:	78 15                	js     80104ad8 <sys_fstat+0x48>
    return -1;
  return filestat(f, st);
80104ac3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ac6:	89 44 24 04          	mov    %eax,0x4(%esp)
80104aca:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104acd:	89 04 24             	mov    %eax,(%esp)
80104ad0:	e8 1b c4 ff ff       	call   80100ef0 <filestat>
}
80104ad5:	c9                   	leave  
80104ad6:	c3                   	ret    
80104ad7:	90                   	nop
...
80104ae6:	83 ec 3c             	sub    $0x3c,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104ae9:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80104aec:	89 44 24 04          	mov    %eax,0x4(%esp)
80104af0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104af7:	e8 24 fb ff ff       	call   80104620 <argstr>
80104afc:	85 c0                	test   %eax,%eax
80104afe:	0f 88 e6 00 00 00    	js     80104bea <sys_link+0x10a>
80104b04:	8d 45 d0             	lea    -0x30(%ebp),%eax
80104b07:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b0b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104b12:	e8 09 fb ff ff       	call   80104620 <argstr>
80104b17:	85 c0                	test   %eax,%eax
80104b19:	0f 88 cb 00 00 00    	js     80104bea <sys_link+0x10a>
    return -1;

  begin_op();
80104b1f:	e8 ec df ff ff       	call   80102b10 <begin_op>
  if((ip = namei(old)) == 0){
80104b24:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104b27:	89 04 24             	mov    %eax,(%esp)
80104b2a:	e8 d1 d3 ff ff       	call   80101f00 <namei>
80104b2f:	85 c0                	test   %eax,%eax
80104b31:	89 c3                	mov    %eax,%ebx
80104b33:	0f 84 ac 00 00 00    	je     80104be5 <sys_link+0x105>
    end_op();
    return -1;
  }
...
80104b3c:	e8 6f cb ff ff       	call   801016b0 <ilock>
  if(ip->type == T_DIR){
80104b41:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104b46:	0f 84 91 00 00 00    	je     80104bdd <sys_link+0xfd>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  ip->nlink++;
80104b4c:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  iupdate(ip);
  iunlock(ip);

  if((dp = nameiparent(new, name)) == 0)
80104b51:	8d 7d da             	lea    -0x26(%ebp),%edi
    end_op();
    return -1;
  }
...
80104b57:	e8 94 ca ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104b5c:	89 1c 24             	mov    %ebx,(%esp)
80104b5f:	e8 2c cc ff ff       	call   80101790 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80104b64:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104b67:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104b6b:	89 04 24             	mov    %eax,(%esp)
80104b6e:	e8 ad d3 ff ff       	call   80101f20 <nameiparent>
80104b73:	85 c0                	test   %eax,%eax
80104b75:	89 c6                	mov    %eax,%esi
80104b77:	74 4f                	je     80104bc8 <sys_link+0xe8>
    goto bad;
  ilock(dp);
80104b79:	89 04 24             	mov    %eax,(%esp)
80104b7c:	e8 2f cb ff ff       	call   801016b0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104b81:	8b 03                	mov    (%ebx),%eax
80104b83:	39 06                	cmp    %eax,(%esi)
80104b85:	75 39                	jne    80104bc0 <sys_link+0xe0>
80104b87:	8b 43 04             	mov    0x4(%ebx),%eax
80104b8a:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104b8e:	89 34 24             	mov    %esi,(%esp)
80104b91:	89 44 24 08          	mov    %eax,0x8(%esp)
80104b95:	e8 86 d2 ff ff       	call   80101e20 <dirlink>
80104b9a:	85 c0                	test   %eax,%eax
80104b9c:	78 22                	js     80104bc0 <sys_link+0xe0>
    iunlockput(dp);
    goto bad;
  }
  iunlockput(dp);
80104b9e:	89 34 24             	mov    %esi,(%esp)
80104ba1:	e8 6a cd ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104ba6:	89 1c 24             	mov    %ebx,(%esp)
80104ba9:	e8 22 cc ff ff       	call   801017d0 <iput>

  end_op();
80104bae:	e8 cd df ff ff       	call   80102b80 <end_op>
  ip->nlink--;
  iupdate(ip);
  iunlockput(ip);
  end_op();
...
80104bb3:	83 c4 3c             	add    $0x3c,%esp
  iunlockput(dp);
  iput(ip);
...
80104bc3:	e8 48 cd ff ff       	call   80101910 <iunlockput>
  end_op();
...
bad:
  ilock(ip);
80104bc8:	89 1c 24             	mov    %ebx,(%esp)
80104bcb:	e8 e0 ca ff ff       	call   801016b0 <ilock>
  ip->nlink--;
80104bd0:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104bd5:	89 1c 24             	mov    %ebx,(%esp)
80104bd8:	e8 13 ca ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
80104bdd:	89 1c 24             	mov    %ebx,(%esp)
80104be0:	e8 2b cd ff ff       	call   80101910 <iunlockput>
  end_op();
80104be5:	e8 96 df ff ff       	call   80102b80 <end_op>
  return -1;
}
...
80104c17:	e8 04 fa ff ff       	call   80104620 <argstr>
...
80104c36:	e8 e5 d2 ff ff       	call   80101f20 <nameiparent>
...
80104c51:	c7 44 24 04 98 73 10 	movl   $0x80107398,0x4(%esp)
80104c58:	80 
80104c59:	89 1c 24             	mov    %ebx,(%esp)
80104c5c:	e8 2f cf ff ff       	call   80101b90 <namecmp>
80104c61:	85 c0                	test   %eax,%eax
80104c63:	0f 84 21 01 00 00    	je     80104d8a <sys_unlink+0x18a>
80104c69:	c7 44 24 04 97 73 10 	movl   $0x80107397,0x4(%esp)
80104c70:	80 
80104c71:	89 1c 24             	mov    %ebx,(%esp)
80104c74:	e8 17 cf ff ff       	call   80101b90 <namecmp>
...
80104c8f:	e8 2c cf ff ff       	call   80101bc0 <dirlookup>
...
80104ca1:	e8 0a ca ff ff       	call   801016b0 <ilock>
...
80104cce:	e8 cd f5 ff ff       	call   801042a0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104cec:	e8 6f cd ff ff       	call   80101a60 <writei>
...
80104d0b:	e8 00 cc ff ff       	call   80101910 <iunlockput>
...
80104d71:	e8 ea cb ff ff       	call   80101960 <readi>
...
80104d85:	e8 86 cb ff ff       	call   80101910 <iunlockput>
  end_op();
...
80104d90:	e8 7b cb ff ff       	call   80101910 <iunlockput>
  end_op();
...
80104db3:	e8 38 c8 ff ff       	call   801015f0 <iupdate>
80104db8:	e9 48 ff ff ff       	jmp    80104d05 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104dbd:	c7 04 24 bc 73 10 80 	movl   $0x801073bc,(%esp)
80104dc4:	e8 97 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104dc9:	c7 04 24 ce 73 10 80 	movl   $0x801073ce,(%esp)
80104dd0:	e8 8b b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104dd5:	c7 04 24 aa 73 10 80 	movl   $0x801073aa,(%esp)
...
80104e07:	e8 14 f8 ff ff       	call   80104620 <argstr>
...
80104e22:	e8 69 f7 ff ff       	call   80104590 <argint>
...
80104e44:	e8 b7 d0 ff ff       	call   80101f00 <namei>
...
80104e75:	e8 86 f8 ff ff       	call   80104700 <fdalloc>
...
80104e87:	e8 04 c9 ff ff       	call   80101790 <iunlock>
  end_op();
...
80104ed1:	e8 6a f8 ff ff       	call   80104740 <create>
    if(ip == 0){
...
80104f0b:	e8 00 ca ff ff       	call   80101910 <iunlockput>
...
80104f49:	e8 d2 f6 ff ff       	call   80104620 <argstr>
...
80104f63:	e8 d8 f7 ff ff       	call   80104740 <create>
...
80104f6f:	e8 9c c9 ff ff       	call   80101910 <iunlockput>
  end_op();
...
80104fa9:	e8 72 f6 ff ff       	call   80104620 <argstr>
...
80104fc0:	e8 cb f5 ff ff       	call   80104590 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
80104fd7:	e8 b4 f5 ff ff       	call   80104590 <argint>
  char *path;
  int major, minor;
...
80104ff3:	e8 48 f7 ff ff       	call   80104740 <create>
...
80105025:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105028:	e8 73 e6 ff ff       	call   801036a0 <myproc>
...
80105042:	e8 d9 f5 ff ff       	call   80104620 <argstr>
...
80105051:	e8 aa ce ff ff       	call   80101f00 <namei>
...
8010505f:	e8 4c c6 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
...
8010506c:	75 22                	jne    80105090 <sys_chdir+0x70>
  ...
  iunlock(ip);
8010506e:	e8 1d c7 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105073:	8b 46 68             	mov    0x68(%esi),%eax
80105076:	89 04 24             	mov    %eax,(%esp)
80105079:	e8 52 c7 ff ff       	call   801017d0 <iput>
  end_op();
...
8010508f:	90                   	nop
  ...
  if(ip->type != T_DIR){
    iunlockput(ip);
80105090:	e8 7b c8 ff ff       	call   80101910 <iunlockput>
    end_op();
...
801050cd:	e8 4e f5 ff ff       	call   80104620 <argstr>
...
801050eb:	e8 a0 f4 ff ff       	call   80104590 <argint>
...
8010511b:	e8 80 f1 ff ff       	call   801042a0 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
...
80105130:	e8 bb f3 ff ff       	call   801044f0 <fetchint>
...
8010514a:	e8 e1 f3 ff ff       	call   80104530 <fetchstr>
...
801051bd:	e8 fe f3 ff ff       	call   801045c0 <argptr>
...
801051df:	e8 1c f5 ff ff       	call   80104700 <fdalloc>
...
801051ed:	e8 0e f5 ff ff       	call   80104700 <fdalloc>
...
80105209:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105210:	e8 8b e4 ff ff       	call   801036a0 <myproc>
...
{
  return fork();
80105244:	e9 07 e6 ff ff       	jmp    80103850 <fork>
...
80105253:	83 ec 08             	sub    $0x8,%esp
  exit();
80105256:	e8 45 e8 ff ff       	call   80103aa0 <exit>
...
{
  return wait();
80105264:	e9 47 ea ff ff       	jmp    80103cb0 <wait>
...
80105284:	e8 07 f3 ff ff       	call   80104590 <argint>
...
80105293:	e8 58 eb ff ff       	call   80103df0 <kill>
}
80105298:	c9                   	leave  
80105299:	c3                   	ret    
...
801052b3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801052b6:	e8 e5 e3 ff ff       	call   801036a0 <myproc>
...
801052d5:	e8 b6 f2 ff ff       	call   80104590 <argint>
801052da:	85 c0                	test   %eax,%eax
801052dc:	78 22                	js     80105300 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801052de:	e8 bd e3 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
...
801052eb:	e8 f0 e4 ff ff       	call   801037e0 <growproc>
...
80105325:	e8 66 f2 ff ff       	call   80104590 <argint>
8010532a:	85 c0                	test   %eax,%eax
8010532c:	78 7e                	js     801053ac <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010532e:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
80105335:	e8 a6 ee ff ff       	call   801041e0 <acquire>
  ticks0 = ticks;
...
8010533a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
8010533d:	8b 1d c0 55 11 80    	mov    0x801155c0,%ebx
  while(ticks - ticks0 < n){
...
80105350:	c7 44 24 04 80 4d 11 	movl   $0x80114d80,0x4(%esp)
80105357:	80 
80105358:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
8010535f:	e8 9c e8 ff ff       	call   80103c00 <sleep>
...
80105394:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105398:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
8010539f:	e8 ac ee ff ff       	call   80104250 <release>
  return 0;
}
...
801053c4:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
801053c7:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
801053ce:	e8 0d ee ff ff       	call   801041e0 <acquire>
  xticks = ticks;
801053d3:	8b 1d c0 55 11 80    	mov    0x801155c0,%ebx
  release(&tickslock);
801053d9:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
801053e0:	e8 6b ee ff ff       	call   80104250 <release>
  return xticks;
}
...
801053f6:	e8 a5 e2 ff ff       	call   801036a0 <myproc>
801053fb:	8b 40 7c             	mov    0x7c(%eax),%eax
}
801053fe:	c9                   	leave  
801053ff:	c3                   	ret    
...
80105401:	06                   	push   %es
  pushl %fs
80105402:	0f a0                	push   %fs
  pushl %gs
80105404:	0f a8                	push   %gs
  pushal
80105406:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105407:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010540b:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010540d:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010540f:	54                   	push   %esp
  call trap
80105410:	e8 eb 00 00 00       	call   80105500 <trap>
  addl $4, %esp
80105415:	83 c4 04             	add    $0x4,%esp
...
80105418:	61                   	popa   
  popl %gs
80105419:	0f a9                	pop    %gs
  popl %fs
8010541b:	0f a1                	pop    %fs
  popl %es
8010541d:	07                   	pop    %es
  popl %ds
8010541e:	1f                   	pop    %ds
...
8010541f:	83 c4 08             	add    $0x8,%esp
  iret
80105422:	cf                   	iret   
80105423:	66 90                	xchg   %ax,%ax
80105425:	66 90                	xchg   %ax,%ax
80105427:	66 90                	xchg   %ax,%ax
...
80105438:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
...
80105481:	83 ec 18             	sub    $0x18,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105484:	a1 0c a1 10 80       	mov    0x8010a10c,%eax

  initlock(&tickslock, "time");
80105489:	c7 44 24 04 dd 73 10 	movl   $0x801073dd,0x4(%esp)
80105490:	80 
...
80105520:	ff 24 85 84 74 10 80 	jmp    *-0x7fef8b7c(,%eax,4)
80105527:	90                   	nop
    lapiceoi();
    break;
...
80105593:	c7 04 24 40 74 10 80 	movl   $0x80107440,(%esp)
...
8010561b:	75 a8                	jne    801055c5 <trap+0xc5>
    exit();
8010561d:	e8 7e e4 ff ff       	call   80103aa0 <exit>
...
80105630:	75 a9                	jne    801055db <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105632:	e8 89 e5 ff ff       	call   80103bc0 <yield>
...
8010568c:	c7 04 24 e8 73 10 80 	movl   $0x801073e8,(%esp)
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801056f8:	e8 a3 e3 ff ff       	call   80103aa0 <exit>
...
801056ff:	90                   	nop
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
80105700:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
80105707:	e8 d4 ea ff ff       	call   801041e0 <acquire>
      ticks++;
      wakeup(&ticks);
8010570c:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105713:	83 05 c0 55 11 80 01 	addl   $0x1,0x801155c0
      wakeup(&ticks);
8010571a:	e8 71 e6 ff ff       	call   80103d90 <wakeup>
      release(&tickslock);
8010571f:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
...
80105736:	e8 45 df ff ff       	call   80103680 <cpuid>
...
8010574a:	c7 04 24 0c 74 10 80 	movl   $0x8010740c,(%esp)
80105751:	89 44 24 04          	mov    %eax,0x4(%esp)
80105755:	e8 f6 ae ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010575a:	c7 04 24 e2 73 10 80 	movl   $0x801073e2,(%esp)
...
{
  if(!uart)
80105770:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
  outb(COM1+0, c);
}
...
801057c7:	e8 d4 cf ff ff       	call   801027a0 <microdelay>
{
  int i;
...
8010583e:	74 42                	je     80105882 <uartinit+0x92>
    return;
  uart = 1;
80105840:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105847:	00 00 00 
...
80105857:	00 
  ...
  for(p="xv6...\n"; *p; p++)
80105858:	bb 04 75 10 80       	mov    $0x80107504,%ebx
...
80105864:	e8 47 ca ff ff       	call   801022b0 <ioapicenable>
...
801058a6:	6a 00                	push   $0x0
  jmp alltraps
801058a8:	e9 53 fb ff ff       	jmp    80105400 <alltraps>
...
801058af:	6a 01                	push   $0x1
  jmp alltraps
801058b1:	e9 4a fb ff ff       	jmp    80105400 <alltraps>
...
801058b8:	6a 02                	push   $0x2
  jmp alltraps
801058ba:	e9 41 fb ff ff       	jmp    80105400 <alltraps>
...
801058c1:	6a 03                	push   $0x3
  jmp alltraps
801058c3:	e9 38 fb ff ff       	jmp    80105400 <alltraps>
...
801058ca:	6a 04                	push   $0x4
  jmp alltraps
801058cc:	e9 2f fb ff ff       	jmp    80105400 <alltraps>
...
801058d3:	6a 05                	push   $0x5
  jmp alltraps
801058d5:	e9 26 fb ff ff       	jmp    80105400 <alltraps>
...
801058dc:	6a 06                	push   $0x6
  jmp alltraps
801058de:	e9 1d fb ff ff       	jmp    80105400 <alltraps>
...
801058e5:	6a 07                	push   $0x7
  jmp alltraps
801058e7:	e9 14 fb ff ff       	jmp    80105400 <alltraps>
...
801058ec:	6a 08                	push   $0x8
  jmp alltraps
801058ee:	e9 0d fb ff ff       	jmp    80105400 <alltraps>
...
801058f5:	6a 09                	push   $0x9
  jmp alltraps
801058f7:	e9 04 fb ff ff       	jmp    80105400 <alltraps>
...
801058fc:	6a 0a                	push   $0xa
  jmp alltraps
801058fe:	e9 fd fa ff ff       	jmp    80105400 <alltraps>
...
80105903:	6a 0b                	push   $0xb
  jmp alltraps
80105905:	e9 f6 fa ff ff       	jmp    80105400 <alltraps>
...
8010590a:	6a 0c                	push   $0xc
  jmp alltraps
8010590c:	e9 ef fa ff ff       	jmp    80105400 <alltraps>
...
80105911:	6a 0d                	push   $0xd
  jmp alltraps
80105913:	e9 e8 fa ff ff       	jmp    80105400 <alltraps>
...
80105918:	6a 0e                	push   $0xe
  jmp alltraps
8010591a:	e9 e1 fa ff ff       	jmp    80105400 <alltraps>
...
80105921:	6a 0f                	push   $0xf
  jmp alltraps
80105923:	e9 d8 fa ff ff       	jmp    80105400 <alltraps>
...
8010592a:	6a 10                	push   $0x10
  jmp alltraps
8010592c:	e9 cf fa ff ff       	jmp    80105400 <alltraps>
...
80105931:	6a 11                	push   $0x11
  jmp alltraps
80105933:	e9 c8 fa ff ff       	jmp    80105400 <alltraps>
...
8010593a:	6a 12                	push   $0x12
  jmp alltraps
8010593c:	e9 bf fa ff ff       	jmp    80105400 <alltraps>
...
80105943:	6a 13                	push   $0x13
  jmp alltraps
80105945:	e9 b6 fa ff ff       	jmp    80105400 <alltraps>
...
8010594c:	6a 14                	push   $0x14
  jmp alltraps
8010594e:	e9 ad fa ff ff       	jmp    80105400 <alltraps>
...
80105955:	6a 15                	push   $0x15
  jmp alltraps
80105957:	e9 a4 fa ff ff       	jmp    80105400 <alltraps>
...
8010595e:	6a 16                	push   $0x16
  jmp alltraps
80105960:	e9 9b fa ff ff       	jmp    80105400 <alltraps>
...
80105967:	6a 17                	push   $0x17
  jmp alltraps
80105969:	e9 92 fa ff ff       	jmp    80105400 <alltraps>
...
80105970:	6a 18                	push   $0x18
  jmp alltraps
80105972:	e9 89 fa ff ff       	jmp    80105400 <alltraps>
...
80105979:	6a 19                	push   $0x19
  jmp alltraps
8010597b:	e9 80 fa ff ff       	jmp    80105400 <alltraps>
...
80105982:	6a 1a                	push   $0x1a
  jmp alltraps
80105984:	e9 77 fa ff ff       	jmp    80105400 <alltraps>
...
8010598b:	6a 1b                	push   $0x1b
  jmp alltraps
8010598d:	e9 6e fa ff ff       	jmp    80105400 <alltraps>
...
80105994:	6a 1c                	push   $0x1c
  jmp alltraps
80105996:	e9 65 fa ff ff       	jmp    80105400 <alltraps>
...
8010599d:	6a 1d                	push   $0x1d
  jmp alltraps
8010599f:	e9 5c fa ff ff       	jmp    80105400 <alltraps>
...
801059a6:	6a 1e                	push   $0x1e
  jmp alltraps
801059a8:	e9 53 fa ff ff       	jmp    80105400 <alltraps>
...
801059af:	6a 1f                	push   $0x1f
  jmp alltraps
801059b1:	e9 4a fa ff ff       	jmp    80105400 <alltraps>
...
801059b8:	6a 20                	push   $0x20
  jmp alltraps
801059ba:	e9 41 fa ff ff       	jmp    80105400 <alltraps>
...
801059c1:	6a 21                	push   $0x21
  jmp alltraps
801059c3:	e9 38 fa ff ff       	jmp    80105400 <alltraps>
...
801059ca:	6a 22                	push   $0x22
  jmp alltraps
801059cc:	e9 2f fa ff ff       	jmp    80105400 <alltraps>
...
801059d3:	6a 23                	push   $0x23
  jmp alltraps
801059d5:	e9 26 fa ff ff       	jmp    80105400 <alltraps>
...
801059dc:	6a 24                	push   $0x24
  jmp alltraps
801059de:	e9 1d fa ff ff       	jmp    80105400 <alltraps>
...
801059e5:	6a 25                	push   $0x25
  jmp alltraps
801059e7:	e9 14 fa ff ff       	jmp    80105400 <alltraps>
...
801059ee:	6a 26                	push   $0x26
  jmp alltraps
801059f0:	e9 0b fa ff ff       	jmp    80105400 <alltraps>
...
801059f7:	6a 27                	push   $0x27
  jmp alltraps
801059f9:	e9 02 fa ff ff       	jmp    80105400 <alltraps>
...
80105a00:	6a 28                	push   $0x28
  jmp alltraps
80105a02:	e9 f9 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a09:	6a 29                	push   $0x29
  jmp alltraps
80105a0b:	e9 f0 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a12:	6a 2a                	push   $0x2a
  jmp alltraps
80105a14:	e9 e7 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a1b:	6a 2b                	push   $0x2b
  jmp alltraps
80105a1d:	e9 de f9 ff ff       	jmp    80105400 <alltraps>
...
80105a24:	6a 2c                	push   $0x2c
  jmp alltraps
80105a26:	e9 d5 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a2d:	6a 2d                	push   $0x2d
  jmp alltraps
80105a2f:	e9 cc f9 ff ff       	jmp    80105400 <alltraps>
...
80105a36:	6a 2e                	push   $0x2e
  jmp alltraps
80105a38:	e9 c3 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a3f:	6a 2f                	push   $0x2f
  jmp alltraps
80105a41:	e9 ba f9 ff ff       	jmp    80105400 <alltraps>
...
80105a48:	6a 30                	push   $0x30
  jmp alltraps
80105a4a:	e9 b1 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a51:	6a 31                	push   $0x31
  jmp alltraps
80105a53:	e9 a8 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a5a:	6a 32                	push   $0x32
  jmp alltraps
80105a5c:	e9 9f f9 ff ff       	jmp    80105400 <alltraps>
...
80105a63:	6a 33                	push   $0x33
  jmp alltraps
80105a65:	e9 96 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a6c:	6a 34                	push   $0x34
  jmp alltraps
80105a6e:	e9 8d f9 ff ff       	jmp    80105400 <alltraps>
...
80105a75:	6a 35                	push   $0x35
  jmp alltraps
80105a77:	e9 84 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a7e:	6a 36                	push   $0x36
  jmp alltraps
80105a80:	e9 7b f9 ff ff       	jmp    80105400 <alltraps>
...
80105a87:	6a 37                	push   $0x37
  jmp alltraps
80105a89:	e9 72 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a90:	6a 38                	push   $0x38
  jmp alltraps
80105a92:	e9 69 f9 ff ff       	jmp    80105400 <alltraps>
...
80105a99:	6a 39                	push   $0x39
  jmp alltraps
80105a9b:	e9 60 f9 ff ff       	jmp    80105400 <alltraps>
...
80105aa2:	6a 3a                	push   $0x3a
  jmp alltraps
80105aa4:	e9 57 f9 ff ff       	jmp    80105400 <alltraps>
...
80105aab:	6a 3b                	push   $0x3b
  jmp alltraps
80105aad:	e9 4e f9 ff ff       	jmp    80105400 <alltraps>
...
80105ab4:	6a 3c                	push   $0x3c
  jmp alltraps
80105ab6:	e9 45 f9 ff ff       	jmp    80105400 <alltraps>
...
80105abd:	6a 3d                	push   $0x3d
  jmp alltraps
80105abf:	e9 3c f9 ff ff       	jmp    80105400 <alltraps>
...
80105ac6:	6a 3e                	push   $0x3e
  jmp alltraps
80105ac8:	e9 33 f9 ff ff       	jmp    80105400 <alltraps>
...
80105acf:	6a 3f                	push   $0x3f
  jmp alltraps
80105ad1:	e9 2a f9 ff ff       	jmp    80105400 <alltraps>
...
80105ad8:	6a 40                	push   $0x40
  jmp alltraps
80105ada:	e9 21 f9 ff ff       	jmp    80105400 <alltraps>
...
80105ae1:	6a 41                	push   $0x41
  jmp alltraps
80105ae3:	e9 18 f9 ff ff       	jmp    80105400 <alltraps>
...
80105aea:	6a 42                	push   $0x42
  jmp alltraps
80105aec:	e9 0f f9 ff ff       	jmp    80105400 <alltraps>
...
80105af3:	6a 43                	push   $0x43
  jmp alltraps
80105af5:	e9 06 f9 ff ff       	jmp    80105400 <alltraps>
...
80105afc:	6a 44                	push   $0x44
  jmp alltraps
80105afe:	e9 fd f8 ff ff       	jmp    80105400 <alltraps>
...
80105b05:	6a 45                	push   $0x45
  jmp alltraps
80105b07:	e9 f4 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b0e:	6a 46                	push   $0x46
  jmp alltraps
80105b10:	e9 eb f8 ff ff       	jmp    80105400 <alltraps>
...
80105b17:	6a 47                	push   $0x47
  jmp alltraps
80105b19:	e9 e2 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b20:	6a 48                	push   $0x48
  jmp alltraps
80105b22:	e9 d9 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b29:	6a 49                	push   $0x49
  jmp alltraps
80105b2b:	e9 d0 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b32:	6a 4a                	push   $0x4a
  jmp alltraps
80105b34:	e9 c7 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b3b:	6a 4b                	push   $0x4b
  jmp alltraps
80105b3d:	e9 be f8 ff ff       	jmp    80105400 <alltraps>
...
80105b44:	6a 4c                	push   $0x4c
  jmp alltraps
80105b46:	e9 b5 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b4d:	6a 4d                	push   $0x4d
  jmp alltraps
80105b4f:	e9 ac f8 ff ff       	jmp    80105400 <alltraps>
...
80105b56:	6a 4e                	push   $0x4e
  jmp alltraps
80105b58:	e9 a3 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b5f:	6a 4f                	push   $0x4f
  jmp alltraps
80105b61:	e9 9a f8 ff ff       	jmp    80105400 <alltraps>
...
80105b68:	6a 50                	push   $0x50
  jmp alltraps
80105b6a:	e9 91 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b71:	6a 51                	push   $0x51
  jmp alltraps
80105b73:	e9 88 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b7a:	6a 52                	push   $0x52
  jmp alltraps
80105b7c:	e9 7f f8 ff ff       	jmp    80105400 <alltraps>
...
80105b83:	6a 53                	push   $0x53
  jmp alltraps
80105b85:	e9 76 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b8c:	6a 54                	push   $0x54
  jmp alltraps
80105b8e:	e9 6d f8 ff ff       	jmp    80105400 <alltraps>
...
80105b95:	6a 55                	push   $0x55
  jmp alltraps
80105b97:	e9 64 f8 ff ff       	jmp    80105400 <alltraps>
...
80105b9e:	6a 56                	push   $0x56
  jmp alltraps
80105ba0:	e9 5b f8 ff ff       	jmp    80105400 <alltraps>
...
80105ba7:	6a 57                	push   $0x57
  jmp alltraps
80105ba9:	e9 52 f8 ff ff       	jmp    80105400 <alltraps>
...
80105bb0:	6a 58                	push   $0x58
  jmp alltraps
80105bb2:	e9 49 f8 ff ff       	jmp    80105400 <alltraps>
...
80105bb9:	6a 59                	push   $0x59
  jmp alltraps
80105bbb:	e9 40 f8 ff ff       	jmp    80105400 <alltraps>
...
80105bc2:	6a 5a                	push   $0x5a
  jmp alltraps
80105bc4:	e9 37 f8 ff ff       	jmp    80105400 <alltraps>
...
80105bcb:	6a 5b                	push   $0x5b
  jmp alltraps
80105bcd:	e9 2e f8 ff ff       	jmp    80105400 <alltraps>
...
80105bd4:	6a 5c                	push   $0x5c
  jmp alltraps
80105bd6:	e9 25 f8 ff ff       	jmp    80105400 <alltraps>
...
80105bdd:	6a 5d                	push   $0x5d
  jmp alltraps
80105bdf:	e9 1c f8 ff ff       	jmp    80105400 <alltraps>
...
80105be6:	6a 5e                	push   $0x5e
  jmp alltraps
80105be8:	e9 13 f8 ff ff       	jmp    80105400 <alltraps>
...
80105bef:	6a 5f                	push   $0x5f
  jmp alltraps
80105bf1:	e9 0a f8 ff ff       	jmp    80105400 <alltraps>
...
80105bf8:	6a 60                	push   $0x60
  jmp alltraps
80105bfa:	e9 01 f8 ff ff       	jmp    80105400 <alltraps>
...
80105c01:	6a 61                	push   $0x61
  jmp alltraps
80105c03:	e9 f8 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c0a:	6a 62                	push   $0x62
  jmp alltraps
80105c0c:	e9 ef f7 ff ff       	jmp    80105400 <alltraps>
...
80105c13:	6a 63                	push   $0x63
  jmp alltraps
80105c15:	e9 e6 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c1c:	6a 64                	push   $0x64
  jmp alltraps
80105c1e:	e9 dd f7 ff ff       	jmp    80105400 <alltraps>
...
80105c25:	6a 65                	push   $0x65
  jmp alltraps
80105c27:	e9 d4 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c2e:	6a 66                	push   $0x66
  jmp alltraps
80105c30:	e9 cb f7 ff ff       	jmp    80105400 <alltraps>
...
80105c37:	6a 67                	push   $0x67
  jmp alltraps
80105c39:	e9 c2 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c40:	6a 68                	push   $0x68
  jmp alltraps
80105c42:	e9 b9 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c49:	6a 69                	push   $0x69
  jmp alltraps
80105c4b:	e9 b0 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c52:	6a 6a                	push   $0x6a
  jmp alltraps
80105c54:	e9 a7 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c5b:	6a 6b                	push   $0x6b
  jmp alltraps
80105c5d:	e9 9e f7 ff ff       	jmp    80105400 <alltraps>
...
80105c64:	6a 6c                	push   $0x6c
  jmp alltraps
80105c66:	e9 95 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c6d:	6a 6d                	push   $0x6d
  jmp alltraps
80105c6f:	e9 8c f7 ff ff       	jmp    80105400 <alltraps>
...
80105c76:	6a 6e                	push   $0x6e
  jmp alltraps
80105c78:	e9 83 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c7f:	6a 6f                	push   $0x6f
  jmp alltraps
80105c81:	e9 7a f7 ff ff       	jmp    80105400 <alltraps>
...
80105c88:	6a 70                	push   $0x70
  jmp alltraps
80105c8a:	e9 71 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c91:	6a 71                	push   $0x71
  jmp alltraps
80105c93:	e9 68 f7 ff ff       	jmp    80105400 <alltraps>
...
80105c9a:	6a 72                	push   $0x72
  jmp alltraps
80105c9c:	e9 5f f7 ff ff       	jmp    80105400 <alltraps>
...
80105ca3:	6a 73                	push   $0x73
  jmp alltraps
80105ca5:	e9 56 f7 ff ff       	jmp    80105400 <alltraps>
...
80105cac:	6a 74                	push   $0x74
  jmp alltraps
80105cae:	e9 4d f7 ff ff       	jmp    80105400 <alltraps>
...
80105cb5:	6a 75                	push   $0x75
  jmp alltraps
80105cb7:	e9 44 f7 ff ff       	jmp    80105400 <alltraps>
...
80105cbe:	6a 76                	push   $0x76
  jmp alltraps
80105cc0:	e9 3b f7 ff ff       	jmp    80105400 <alltraps>
...
80105cc7:	6a 77                	push   $0x77
  jmp alltraps
80105cc9:	e9 32 f7 ff ff       	jmp    80105400 <alltraps>
...
80105cd0:	6a 78                	push   $0x78
  jmp alltraps
80105cd2:	e9 29 f7 ff ff       	jmp    80105400 <alltraps>
...
80105cd9:	6a 79                	push   $0x79
  jmp alltraps
80105cdb:	e9 20 f7 ff ff       	jmp    80105400 <alltraps>
...
80105ce2:	6a 7a                	push   $0x7a
  jmp alltraps
80105ce4:	e9 17 f7 ff ff       	jmp    80105400 <alltraps>
...
80105ceb:	6a 7b                	push   $0x7b
  jmp alltraps
80105ced:	e9 0e f7 ff ff       	jmp    80105400 <alltraps>
...
80105cf4:	6a 7c                	push   $0x7c
  jmp alltraps
80105cf6:	e9 05 f7 ff ff       	jmp    80105400 <alltraps>
...
80105cfd:	6a 7d                	push   $0x7d
  jmp alltraps
80105cff:	e9 fc f6 ff ff       	jmp    80105400 <alltraps>
...
80105d06:	6a 7e                	push   $0x7e
  jmp alltraps
80105d08:	e9 f3 f6 ff ff       	jmp    80105400 <alltraps>
...
80105d0f:	6a 7f                	push   $0x7f
  jmp alltraps
80105d11:	e9 ea f6 ff ff       	jmp    80105400 <alltraps>
...
80105d18:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105d1d:	e9 de f6 ff ff       	jmp    80105400 <alltraps>
...
80105d24:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105d29:	e9 d2 f6 ff ff       	jmp    80105400 <alltraps>
...
80105d30:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105d35:	e9 c6 f6 ff ff       	jmp    80105400 <alltraps>
...
80105d3c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105d41:	e9 ba f6 ff ff       	jmp    80105400 <alltraps>
...
80105d48:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105d4d:	e9 ae f6 ff ff       	jmp    80105400 <alltraps>
...
80105d54:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105d59:	e9 a2 f6 ff ff       	jmp    80105400 <alltraps>
...
80105d60:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105d65:	e9 96 f6 ff ff       	jmp    80105400 <alltraps>
...
80105d6c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105d71:	e9 8a f6 ff ff       	jmp    80105400 <alltraps>
...
80105d78:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105d7d:	e9 7e f6 ff ff       	jmp    80105400 <alltraps>
...
80105d84:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105d89:	e9 72 f6 ff ff       	jmp    80105400 <alltraps>
...
80105d90:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105d95:	e9 66 f6 ff ff       	jmp    80105400 <alltraps>
...
80105d9c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105da1:	e9 5a f6 ff ff       	jmp    80105400 <alltraps>
...
80105da8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105dad:	e9 4e f6 ff ff       	jmp    80105400 <alltraps>
...
80105db4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105db9:	e9 42 f6 ff ff       	jmp    80105400 <alltraps>
...
80105dc0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105dc5:	e9 36 f6 ff ff       	jmp    80105400 <alltraps>
...
80105dcc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105dd1:	e9 2a f6 ff ff       	jmp    80105400 <alltraps>
...
80105dd8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105ddd:	e9 1e f6 ff ff       	jmp    80105400 <alltraps>
...
80105de4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105de9:	e9 12 f6 ff ff       	jmp    80105400 <alltraps>
...
80105df0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105df5:	e9 06 f6 ff ff       	jmp    80105400 <alltraps>
...
80105dfc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105e01:	e9 fa f5 ff ff       	jmp    80105400 <alltraps>
...
80105e08:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105e0d:	e9 ee f5 ff ff       	jmp    80105400 <alltraps>
...
80105e14:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105e19:	e9 e2 f5 ff ff       	jmp    80105400 <alltraps>
...
80105e20:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105e25:	e9 d6 f5 ff ff       	jmp    80105400 <alltraps>
...
80105e2c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105e31:	e9 ca f5 ff ff       	jmp    80105400 <alltraps>
...
80105e38:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105e3d:	e9 be f5 ff ff       	jmp    80105400 <alltraps>
...
80105e44:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105e49:	e9 b2 f5 ff ff       	jmp    80105400 <alltraps>
...
80105e50:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105e55:	e9 a6 f5 ff ff       	jmp    80105400 <alltraps>
...
80105e5c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105e61:	e9 9a f5 ff ff       	jmp    80105400 <alltraps>
...
80105e68:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105e6d:	e9 8e f5 ff ff       	jmp    80105400 <alltraps>
...
80105e74:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105e79:	e9 82 f5 ff ff       	jmp    80105400 <alltraps>
...
80105e80:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105e85:	e9 76 f5 ff ff       	jmp    80105400 <alltraps>
...
80105e8c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105e91:	e9 6a f5 ff ff       	jmp    80105400 <alltraps>
...
80105e98:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105e9d:	e9 5e f5 ff ff       	jmp    80105400 <alltraps>
...
80105ea4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105ea9:	e9 52 f5 ff ff       	jmp    80105400 <alltraps>
...
80105eb0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105eb5:	e9 46 f5 ff ff       	jmp    80105400 <alltraps>
...
80105ebc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105ec1:	e9 3a f5 ff ff       	jmp    80105400 <alltraps>
...
80105ec8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105ecd:	e9 2e f5 ff ff       	jmp    80105400 <alltraps>
...
80105ed4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105ed9:	e9 22 f5 ff ff       	jmp    80105400 <alltraps>
...
80105ee0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105ee5:	e9 16 f5 ff ff       	jmp    80105400 <alltraps>
...
80105eec:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105ef1:	e9 0a f5 ff ff       	jmp    80105400 <alltraps>
...
80105ef8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105efd:	e9 fe f4 ff ff       	jmp    80105400 <alltraps>
...
80105f04:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105f09:	e9 f2 f4 ff ff       	jmp    80105400 <alltraps>
...
80105f10:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105f15:	e9 e6 f4 ff ff       	jmp    80105400 <alltraps>
...
80105f1c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105f21:	e9 da f4 ff ff       	jmp    80105400 <alltraps>
...
80105f28:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105f2d:	e9 ce f4 ff ff       	jmp    80105400 <alltraps>
...
80105f34:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105f39:	e9 c2 f4 ff ff       	jmp    80105400 <alltraps>
...
80105f40:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105f45:	e9 b6 f4 ff ff       	jmp    80105400 <alltraps>
...
80105f4c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105f51:	e9 aa f4 ff ff       	jmp    80105400 <alltraps>
...
80105f58:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105f5d:	e9 9e f4 ff ff       	jmp    80105400 <alltraps>
...
80105f64:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105f69:	e9 92 f4 ff ff       	jmp    80105400 <alltraps>
...
80105f70:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105f75:	e9 86 f4 ff ff       	jmp    80105400 <alltraps>
...
80105f7c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105f81:	e9 7a f4 ff ff       	jmp    80105400 <alltraps>
...
80105f88:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105f8d:	e9 6e f4 ff ff       	jmp    80105400 <alltraps>
...
80105f94:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105f99:	e9 62 f4 ff ff       	jmp    80105400 <alltraps>
...
80105fa0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105fa5:	e9 56 f4 ff ff       	jmp    80105400 <alltraps>
...
80105fac:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105fb1:	e9 4a f4 ff ff       	jmp    80105400 <alltraps>
...
80105fb8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105fbd:	e9 3e f4 ff ff       	jmp    80105400 <alltraps>
...
80105fc4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105fc9:	e9 32 f4 ff ff       	jmp    80105400 <alltraps>
...
80105fd0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105fd5:	e9 26 f4 ff ff       	jmp    80105400 <alltraps>
...
80105fdc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80105fe1:	e9 1a f4 ff ff       	jmp    80105400 <alltraps>
...
80105fe8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105fed:	e9 0e f4 ff ff       	jmp    80105400 <alltraps>
...
80105ff4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105ff9:	e9 02 f4 ff ff       	jmp    80105400 <alltraps>
...
80106000:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106005:	e9 f6 f3 ff ff       	jmp    80105400 <alltraps>
...
8010600c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106011:	e9 ea f3 ff ff       	jmp    80105400 <alltraps>
...
80106018:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010601d:	e9 de f3 ff ff       	jmp    80105400 <alltraps>
...
80106024:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106029:	e9 d2 f3 ff ff       	jmp    80105400 <alltraps>
...
80106030:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106035:	e9 c6 f3 ff ff       	jmp    80105400 <alltraps>
...
8010603c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106041:	e9 ba f3 ff ff       	jmp    80105400 <alltraps>
...
80106048:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010604d:	e9 ae f3 ff ff       	jmp    80105400 <alltraps>
...
80106054:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106059:	e9 a2 f3 ff ff       	jmp    80105400 <alltraps>
...
80106060:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106065:	e9 96 f3 ff ff       	jmp    80105400 <alltraps>
...
8010606c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106071:	e9 8a f3 ff ff       	jmp    80105400 <alltraps>
...
80106078:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010607d:	e9 7e f3 ff ff       	jmp    80105400 <alltraps>
...
80106084:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106089:	e9 72 f3 ff ff       	jmp    80105400 <alltraps>
...
80106090:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106095:	e9 66 f3 ff ff       	jmp    80105400 <alltraps>
...
8010609c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801060a1:	e9 5a f3 ff ff       	jmp    80105400 <alltraps>
...
801060a8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801060ad:	e9 4e f3 ff ff       	jmp    80105400 <alltraps>
...
801060b4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801060b9:	e9 42 f3 ff ff       	jmp    80105400 <alltraps>
...
801060c0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801060c5:	e9 36 f3 ff ff       	jmp    80105400 <alltraps>
...
801060cc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801060d1:	e9 2a f3 ff ff       	jmp    80105400 <alltraps>
...
801060d8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801060dd:	e9 1e f3 ff ff       	jmp    80105400 <alltraps>
...
801060e4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801060e9:	e9 12 f3 ff ff       	jmp    80105400 <alltraps>
...
801060f0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801060f5:	e9 06 f3 ff ff       	jmp    80105400 <alltraps>
...
801060fc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106101:	e9 fa f2 ff ff       	jmp    80105400 <alltraps>
...
80106108:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010610d:	e9 ee f2 ff ff       	jmp    80105400 <alltraps>
...
80106114:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106119:	e9 e2 f2 ff ff       	jmp    80105400 <alltraps>
...
80106120:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106125:	e9 d6 f2 ff ff       	jmp    80105400 <alltraps>
...
8010612c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106131:	e9 ca f2 ff ff       	jmp    80105400 <alltraps>
...
80106138:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010613d:	e9 be f2 ff ff       	jmp    80105400 <alltraps>
...
80106144:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106149:	e9 b2 f2 ff ff       	jmp    80105400 <alltraps>
...
80106150:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106155:	e9 a6 f2 ff ff       	jmp    80105400 <alltraps>
...
8010615c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106161:	e9 9a f2 ff ff       	jmp    80105400 <alltraps>
...
80106168:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010616d:	e9 8e f2 ff ff       	jmp    80105400 <alltraps>
...
80106174:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106179:	e9 82 f2 ff ff       	jmp    80105400 <alltraps>
...
80106180:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106185:	e9 76 f2 ff ff       	jmp    80105400 <alltraps>
...
8010618c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106191:	e9 6a f2 ff ff       	jmp    80105400 <alltraps>
...
80106198:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010619d:	e9 5e f2 ff ff       	jmp    80105400 <alltraps>
...
801061a4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801061a9:	e9 52 f2 ff ff       	jmp    80105400 <alltraps>
...
801061b0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801061b5:	e9 46 f2 ff ff       	jmp    80105400 <alltraps>
...
801061bc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801061c1:	e9 3a f2 ff ff       	jmp    80105400 <alltraps>
...
801061c8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801061cd:	e9 2e f2 ff ff       	jmp    80105400 <alltraps>
...
801061d4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801061d9:	e9 22 f2 ff ff       	jmp    80105400 <alltraps>
...
801061e0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801061e5:	e9 16 f2 ff ff       	jmp    80105400 <alltraps>
...
801061ec:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801061f1:	e9 0a f2 ff ff       	jmp    80105400 <alltraps>
...
801061f8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801061fd:	e9 fe f1 ff ff       	jmp    80105400 <alltraps>
...
80106204:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106209:	e9 f2 f1 ff ff       	jmp    80105400 <alltraps>
...
80106210:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106215:	e9 e6 f1 ff ff       	jmp    80105400 <alltraps>
...
8010621c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106221:	e9 da f1 ff ff       	jmp    80105400 <alltraps>
...
80106228:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010622d:	e9 ce f1 ff ff       	jmp    80105400 <alltraps>
...
80106234:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106239:	e9 c2 f1 ff ff       	jmp    80105400 <alltraps>
...
80106240:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106245:	e9 b6 f1 ff ff       	jmp    80105400 <alltraps>
...
8010624c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106251:	e9 aa f1 ff ff       	jmp    80105400 <alltraps>
...
80106258:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010625d:	e9 9e f1 ff ff       	jmp    80105400 <alltraps>
...
80106264:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106269:	e9 92 f1 ff ff       	jmp    80105400 <alltraps>
...
80106270:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106275:	e9 86 f1 ff ff       	jmp    80105400 <alltraps>
...
8010627c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106281:	e9 7a f1 ff ff       	jmp    80105400 <alltraps>
...
80106288:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010628d:	e9 6e f1 ff ff       	jmp    80105400 <alltraps>
...
80106294:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106299:	e9 62 f1 ff ff       	jmp    80105400 <alltraps>
...
801062a0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801062a5:	e9 56 f1 ff ff       	jmp    80105400 <alltraps>
...
801062ac:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801062b1:	e9 4a f1 ff ff       	jmp    80105400 <alltraps>
...
801062b8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801062bd:	e9 3e f1 ff ff       	jmp    80105400 <alltraps>
...
801062c4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801062c9:	e9 32 f1 ff ff       	jmp    80105400 <alltraps>
...
801062d0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801062d5:	e9 26 f1 ff ff       	jmp    80105400 <alltraps>
...
801062dc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801062e1:	e9 1a f1 ff ff       	jmp    80105400 <alltraps>
...
801062e8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801062ed:	e9 0e f1 ff ff       	jmp    80105400 <alltraps>
...
801062f4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801062f9:	e9 02 f1 ff ff       	jmp    80105400 <alltraps>
...
80106300:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106305:	e9 f6 f0 ff ff       	jmp    80105400 <alltraps>
...
8010630c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106311:	e9 ea f0 ff ff       	jmp    80105400 <alltraps>
...
80106364:	e8 37 c1 ff ff       	call   801024a0 <kalloc>
...
80106382:	e8 19 df ff ff       	call   801042a0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106421:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106422:	c7 04 24 0c 75 10 80 	movl   $0x8010750c,(%esp)
...
80106473:	e8 78 be ff ff       	call   801022f0 <kfree>
      *pte = 0;
...
801064e8:	05 a0 27 11 80       	add    $0x801127a0,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
...
80106590:	a1 c4 55 11 80       	mov    0x801155c4,%eax
...
80106639:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010663e:	e8 bd cf ff ff       	call   80103600 <mycpu>
80106643:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010664a:	e8 b1 cf ff ff       	call   80103600 <mycpu>
...
8010668b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010668c:	e9 9f da ff ff       	jmp    80104130 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106691:	c7 04 24 12 75 10 80 	movl   $0x80107512,(%esp)
80106698:	e8 c3 9c ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010669d:	c7 04 24 3d 75 10 80 	movl   $0x8010753d,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
801066a9:	c7 04 24 28 75 10 80 	movl   $0x80107528,(%esp)
...
801066db:	77 54                	ja     80106731 <inituvm+0x71>
  ...
  mem = kalloc();
801066dd:	e8 be bd ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
801066f7:	e8 a4 db ff ff       	call   801042a0 <memset>
...
8010672b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010672c:	e9 0f dc ff ff       	jmp    80104340 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80106731:	c7 04 24 51 75 10 80 	movl   $0x80107551,(%esp)
...
801067bd:	e8 9e b1 ff ff       	call   80101960 <readi>
...
801067e1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801067e2:	c7 04 24 6b 75 10 80 	movl   $0x8010756b,(%esp)
801067e9:	e8 72 9b ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
801067ee:	c7 04 24 0c 76 10 80 	movl   $0x8010760c,(%esp)
...
80106843:	e8 58 da ff ff       	call   801042a0 <memset>
...
80106874:	76 2a                	jbe    801068a0 <allocuvm+0xa0>
    mem = kalloc();
80106876:	e8 25 bc ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
8010687f:	75 af                	jne    80106830 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106881:	c7 04 24 89 75 10 80 	movl   $0x80107589,(%esp)
...
801068aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
801068b0:	c7 04 24 a1 75 10 80 	movl   $0x801075a1,(%esp)
...
801068d1:	e8 1a ba ff ff       	call   801022f0 <kfree>
      return 0;
...
8010695d:	e8 8e b9 ff ff       	call   801022f0 <kfree>
  uint i;
...
80106972:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106973:	e9 78 b9 ff ff       	jmp    801022f0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106978:	c7 04 24 bd 75 10 80 	movl   $0x801075bd,(%esp)
...
80106998:	e8 03 bb ff ff       	call   801024a0 <kalloc>
...
801069bb:	e8 e0 d8 ff ff       	call   801042a0 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106a2b:	a3 c4 55 11 80       	mov    %eax,0x801155c4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80106a5b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106a5c:	c7 04 24 ce 75 10 80 	movl   $0x801075ce,(%esp)
...
80106a83:	0f 84 b9 00 00 00    	je     80106b42 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106a89:	8b 45 0c             	mov    0xc(%ebp),%eax
80106a8c:	85 c0                	test   %eax,%eax
80106a8e:	0f 84 94 00 00 00    	je     80106b28 <copyuvm+0xb8>
...
80106aad:	e8 8e d8 ff ff       	call   80104340 <memmove>
...
80106ade:	76 48                	jbe    80106b28 <copyuvm+0xb8>
...
80106aee:	74 62                	je     80106b52 <copyuvm+0xe2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106af0:	8b 00                	mov    (%eax),%eax
80106af2:	a8 01                	test   $0x1,%al
80106af4:	74 50                	je     80106b46 <copyuvm+0xd6>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106af6:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106af8:	25 ff 0f 00 00       	and    $0xfff,%eax
80106afd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106b00:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106b06:	e8 95 b9 ff ff       	call   801024a0 <kalloc>
80106b0b:	85 c0                	test   %eax,%eax
80106b0d:	89 c3                	mov    %eax,%ebx
80106b0f:	75 87                	jne    80106a98 <copyuvm+0x28>
    }
  }
  return d;
...
80106b17:	e8 f4 fd ff ff       	call   80106910 <freevm>
  return 0;
80106b1c:	31 c0                	xor    %eax,%eax
}
80106b1e:	83 c4 2c             	add    $0x2c,%esp
80106b21:	5b                   	pop    %ebx
80106b22:	5e                   	pop    %esi
80106b23:	5f                   	pop    %edi
80106b24:	5d                   	pop    %ebp
...
80106b28:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b2b:	83 c4 2c             	add    $0x2c,%esp
80106b2e:	5b                   	pop    %ebx
80106b2f:	5e                   	pop    %esi
80106b30:	5f                   	pop    %edi
80106b31:	5d                   	pop    %ebp
...
80106b3b:	e8 b0 b7 ff ff       	call   801022f0 <kfree>
      goto bad;
80106b40:	eb cf                	jmp    80106b11 <copyuvm+0xa1>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
...
80106b44:	eb d8                	jmp    80106b1e <copyuvm+0xae>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106b46:	c7 04 24 f2 75 10 80 	movl   $0x801075f2,(%esp)
80106b4d:	e8 0e 98 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106b52:	c7 04 24 d8 75 10 80 	movl   $0x801075d8,(%esp)
...
80106bdc:	e8 5f d7 ff ff       	call   80104340 <memmove>
    len -= n;
    buf += n;
