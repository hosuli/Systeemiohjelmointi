...
int main(void) {
   ...
   6:	83 ec 10             	sub    $0x10,%esp
	...
	printf(1, "%d\n", getreadcount());
   9:	e8 e4 02 00 00       	call   2f2 <getreadcount>
   e:	c7 44 24 04 06 07 00 	movl   $0x706,0x4(%esp)
  15:	00 
  16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1d:	89 44 24 08          	mov    %eax,0x8(%esp)
  21:	e8 7a 03 00 00       	call   3a0 <printf>
	exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 339:	0f b6 92 11 07 00 00 	movzbl 0x711(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4cf:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 4d1:	b8 0a 07 00 00       	mov    $0x70a,%eax
...
free(void *ap)
{
 ...
 591:	a1 88 09 00 00       	mov    0x988,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5d7:	89 10                	mov    %edx,(%eax)
  freep = p;
 5d9:	a3 88 09 00 00       	mov    %eax,0x988
}
 5de:	5b                   	pop    %ebx
 5df:	5e                   	pop    %esi
 5e0:	5f                   	pop    %edi
 ...
 5ff:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 602:	a3 88 09 00 00       	mov    %eax,0x988
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 1d 88 09 00 00    	mov    0x988,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 669:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 66b:	3b 15 88 09 00 00    	cmp    0x988,%edx
...
morecore(uint nu)
{
 ...
 69d:	e8 ee fe ff ff       	call   590 <free>
  return freep;
 6a2:	8b 15 88 09 00 00    	mov    0x988,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6c4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6c7:	89 15 88 09 00 00    	mov    %edx,0x988
      return (void*)(p + 1);
 ...
 6dc:	eb e9                	jmp    6c7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6de:	c7 05 88 09 00 00 8c 	movl   $0x98c,0x988
 6e5:	09 00 00 
    base.s.size = 0;
 6e8:	ba 8c 09 00 00       	mov    $0x98c,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6ed:	c7 05 8c 09 00 00 8c 	movl   $0x98c,0x98c
 6f4:	09 00 00 
    base.s.size = 0;
 6f7:	c7 05 90 09 00 00 00 	movl   $0x0,0x990
 6fe:	00 00 00 
